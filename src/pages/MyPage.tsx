  ...
  return (
    <div className="max-w-5xl mx-auto">
      <header className="mb-8">
        ...
        <p className="text-gray-600 mt-2">사용자 정보를 확인할 수 있어요</p>
      </header>
      ...
      <div className="bg-white rounded-2xl shadow-sm p-6">
        <h3 className="text-gray-500 text-sm font-medium mb-4">연결된 기기</h3>
        {mockUserData.connectedDevices[0]?.deviceName?.startsWith(
          "WEB_"
        ) ? null : mockUserData.connectedDevices[0]?.deviceName ===
          undefined ? (
